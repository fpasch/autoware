...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_carla_sim = wx.ToggleButton(self.tab_simulation, wx.ID_ANY, _("CARLA Simulator"))
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_carla_sim)
	...
	def __do_layout(self):
		...
		sizer_62_copy_copy_copy_copy_copy_copy.Add(self.button_carla_sim, 0, wx.ALL, 4)
